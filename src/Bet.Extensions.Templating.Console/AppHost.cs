...
namespace Microsoft.Extensions.Hosting
{
    public sealed class AppHost
    {
        ...
        private static IConfiguration GetConfiguration()
        {
            ...
            bool reloadOnChange = initConfig.GetValue("hostBuilder:reloadConfigOnChange", defaultValue: true);
        ...
        public static ILogger CreateSerilogLogger(Action<LoggerConfiguration, IConfiguration, IHostEnvironment> configure = default)
        {
            ...
            {
                throw new ArgumentException("MainHost.Start wasn't called, configuration doesn't exist.");
            }
